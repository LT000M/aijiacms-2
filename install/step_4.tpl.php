...
<tr>
<td>超级管理员户名</td>
<td><input name="username" type="text" id="username" value="aijiacms" style="width:200px"/></td>
...
<tr>
<td>网站访问地址</td>
<td><input name="url" type="text" id="url" value="<?php echo $AJ_URL;?>" style="width:200px"/></td>
