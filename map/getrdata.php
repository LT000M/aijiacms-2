...
//echo  $condition;
    if($price==0 and $price!='' ){$condition.=' AND a.price<200';}
	if($price== 1){
			$condition.=" AND a.price>=200  AND a.price<500";}
	if($price== 2){
			$condition.=' AND a.price>=500 AND a.price<1000';}
	if($price== 3){
			$condition.=' AND a.price>=1000 AND a.price<1500';}
	if($price== 4){
			$condition.=' AND a.price>=1500 AND a.price<2000';}
	if($price== 5){
			$condition.=' AND a.price>=2000 AND a.price<3000';}
	if($price== 6){
			$condition.=' AND 3000<=a.price';}
			//面積範圍
	if($area== 0 and $area!='' ){
