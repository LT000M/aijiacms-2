...
if($p7){
	$mix=mixprice($p7,'range','sale_5');
		$max=salemaxprice($p7,'range','sale_5');
		if($mix){$mix=$mix;}
		else
		{$mix=0;}
...
$linkurl=$MODULE[5][linkurl].$r['linkurl'];
...
<div class="mapFinddingExtInofWind">
  ...
  <div class="mapFinddingExtInofWind_TopLine"><span style="float:left;width:200px;margin-left:5px;" class="newhouseview"><ul>
								<li>價格：<span class="familyAlpha colorF90 size14px weightBold"><?php echo $price;?></span></li>
