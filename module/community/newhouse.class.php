...
function newhouse($moduleid) {
	...
	function update($itemid) {
		...
		DB::query("REPLACE INTO {$this->table_search} (itemid,catid,areaid,area_ditie_id,status,content,sorttime) VALUES ($itemid,'$item[catid]','$item[areaid]','$item[area_ditie_id]','$item[status]','$keyword','$sorttime')");
	}
