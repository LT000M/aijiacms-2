...
<td><input name="setting[sphinx_host]" type="text" size="20" value="<?php echo $sphinx_host;?>"/><?php tips('默认为localhost，可留空');?></td>
</tr>
<tr>
