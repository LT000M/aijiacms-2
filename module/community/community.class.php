...
function community($moduleid) {
	...
	function get_list($condition = 'status=3 and isnew=0', $order = 'edittime DESC', $cache = '') {
	...
	function update($itemid) {
		...
		DB::query("REPLACE INTO {$this->table_search} (itemid,catid,areaid,area_ditie_id,status,content,sorttime) VALUES ($itemid,'$item[catid]','$item[areaid]','$item[areaid_ditie_id]','$item[status]','$keyword','$sorttime')");
	}
