...
$menu_finance = array(
	array($AJ['money_name'].'管理', '?moduleid=2&file=record'),
	array($AJ['credit_name'].'管理', '?moduleid=2&file=credit'),
...
$menu_relate = array(
	...
	array('房源提醒', '?moduleid=2&file=alert'),
	array('邮件订阅', '?moduleid=2&file=mail'),
	array('房源收藏', '?moduleid=2&file=favorite'),
