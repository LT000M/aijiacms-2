...
<td>&nbsp;<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=record&username=<?php echo $username;?>', '<?php echo $AJ['money_name'];?>流水');"><strong class="f_red"><?php echo $money;?></strong></a> <?php echo $AJ['money_unit'];?></td>
<td class="tl">保证金</td>
<td>&nbsp;<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=deposit&username=<?php echo $username;?>', '保证金流水');"><strong class="f_blue"><?php echo $deposit;?></strong></a> <?php echo $AJ['money_unit'];?></td>
</tr>
<tr>
<td class="tl">短信余额</td>
...
<td>&nbsp;<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=credit&username=<?php echo $username;?>', '<?php echo $AJ['credit_name'];?>流水');"><strong class="f_blue"><?php echo $credit;?></strong></a> <?php echo $AJ['credit_unit'];?></td>
</tr>
</table>
...
<tr>
<td class="tl">公司名称</td>
<td colspan="3">&nbsp;<?php echo $company;?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/company.php?wd=<?php echo urlencode($company);?>" target="_blank" class="t">查询</a></td>
</tr>
<tr>
<td class="tl">公司主页</td>
...
<tr>
<td class="tl">销售的房源 (提供的服务)</td>
<td>&nbsp;<?php echo $sell;?></td>
<td class="tl">采购的房源 (需要的服务)</td>
<td>&nbsp;<?php echo $buy;?></td>
</tr>
<tr>
<td class="tl">主营范围：</td>
...
<td>&nbsp;<?php echo $truename;?></td>
<td class="tl">手 机</td>
<td>&nbsp;<?php if($mobile) { ?><a href="javascript:Dwidget('?moduleid=2&file=sendsms&mobile=<?php echo $mobile;?>', '发送短信');"><img src="<?php echo AJ_SKIN;?>image/mobile.gif" title="发送短信" align="absmiddle"/></a> <?php } ?><a href="javascript:_mobile('<?php echo $mobile;?>');" title="归属地查询"><?php echo $mobile;?></a></td>
</tr>
<tr>
<td class="tl">部 门</td>
...
<tr>
<td class="tl">网 址</td>
<td>&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=<?php echo $homepage;?>" target="_blank"><?php echo $homepage;?></a></td>
<td class="tl">邮 编</td>
...
<tr>
<td class="tl"><?php echo $AJ['trade_nm'];?></td>
