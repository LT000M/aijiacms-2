...
<td><a href="javascript:_preview('<?php echo $v['image'];?>');"><img src="<?php echo $v['thumb'];?>" width="50" style="padding:5px;"/></a></td>
...
<input type="submit" value="彻底删除" class="btn-r" onclick="if(confirm('确定要删除选中证书吗？此操作将不可撤销')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>&nbsp;
