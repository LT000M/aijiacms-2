...
<td><input name="amount" id="amount" type="text" size="10"/> <?php echo $AJ['money_unit'];?> <span id="damount" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 事由</td>
<td><input name="reason" id="reason" type="text" size="40" value=""/> <span class="f_gray">客户可见</span> <span id="dreason" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 备注</td>
<td><input name="note" type="text" size="40" value=""/></td>
</tr>
<tr>
