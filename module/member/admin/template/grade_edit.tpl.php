...
<td><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=record&username=<?php echo $username;?>', '<?php echo $AJ['money_name'];?>流水');"><span class="f_red"><?php echo $amount;?></span></a></td>
</tr>
<tr>
