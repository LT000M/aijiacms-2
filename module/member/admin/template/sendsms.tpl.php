...
- 当前已输入<strong id="len1">0</strong>字，签名<strong id="len2">0</strong>字，共<strong id="len3" class="f_red">0</strong>字，分<strong id="len4" class="f_blue">0</strong>条短信 (<?php echo $AJ['sms_len'];?>字/条)<br/>
...
<?php if(!$AJ['sms'] || !AJ_CLOUD_UID || !AJ_CLOUD_KEY) { ?>
<span class="f_red">- 注意：无法发送，未设置发送参数</span> <a href="?file=setting&tab=7" class="t">点此设置</a><br/>
<?php } else { ?>

<span class="f_red">
- 由于政策原因，并非所有内容都可以正常发送...<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://www.aijiacms.com/doc/use/29.html%23faq" target="_blank" class="t">了解详情</a><br/>
