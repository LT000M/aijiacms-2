...
<?php echo $AJ['money_name'];?>：<input type="text" size="2" name="minmoney" value="<?php echo $minmoney;?>"/>~<input type="text" size="2" name="maxmoney" value="<?php echo $maxmoney;?>"/>&nbsp;
<?php echo $AJ['credit_name'];?>：<input type="text" size="2" name="mincredit" value="<?php echo $mincredit;?>"/>~<input type="text" size="2" name="maxcredit" value="<?php echo $maxcredit;?>"/>&nbsp;
...
<td class="px12"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=record&username=<?php echo $v['username'];?>', '[<?php echo $v['username'];?>] <?php echo $AJ['money_name'];?>记录');"><?php echo $v['money'];?></a></td>
<td class="px12"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=credit&username=<?php echo $v['username'];?>', '[<?php echo $v['username'];?>] <?php echo $AJ['credit_name'];?>记录');"><?php echo $v['credit'];?></a></td>
...
<a href="?moduleid=<?php echo $moduleid;?>&action=login&userid=<?php echo $v['userid'];?>" target="_blank"><img src="admin/image/set.png" width="16" height="16" title="进入会员会员中心" alt=""/></a>&nbsp;
...
<input type="submit" value=" <?php echo $AJ['money_name'];?>增减 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=record&action=add';"/>&nbsp;
<input type="submit" value=" <?php echo $AJ['credit_name'];?>奖惩 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=credit&action=add';"/>&nbsp;
