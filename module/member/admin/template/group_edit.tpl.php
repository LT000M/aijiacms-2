...
<tr>
<td class="tl"><span class="f_red">*</span> 季度会员</td>
<td><input type="text" size="20" name="setting[jdfee]" id="jdfee" value="<?php echo $jdfee;?>"/> <?php echo $AJ['money_unit'];?>/季度 <span class="f_gray">免费会员请填0</span> <span id="dfee" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 半年会员</td>
<td><input type="text" size="20" name="setting[bnfee]" id="bnfee" value="<?php echo $bnfee;?>"/> <?php echo $AJ['money_unit'];?>/半年 <span class="f_gray">免费会员请填0</span> <span id="dfee" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 年会员设置</td>
<td><input type="text" size="20" name="setting[fee]" id="fee" value="<?php echo $fee;?>"/> <?php echo $AJ['money_unit'];?>/年 <span class="f_gray">免费会员请填0</span> <span id="dfee" class="f_red"></span></td>
</tr>
<tr>
...
<tr>
<td class="tl">房源图片数量限制</td>
<td><input type="text" size="3" name="setting[maxitem]" value="<?php echo $maxitem;?>"/> 张 最少为1，推荐控制在20内</td>
</tr>
<tr>
...
<input type="radio" name="setting[uploadpt]" value="0" <?php if(!$uploadpt) echo 'checked';?>> 否 <?php tips('如果选择是，房源图片只允许传1张，如果不限可以传3张，此项不针对'.VIP.'会员');?>
</td>
</tr>
<tr>
...
<tr>
<td class="tl">房源提醒数量限制</td>
<td>
<input type="text" name="setting[alert_limit]" size="5" value="<?php echo $alert_limit;?>"/>
</td>
</tr>
<tr>
<td class="tl">	预约管理数量限制</td>
<td>
<input type="text" name="setting[subscribe_limit]" size="5" value="<?php echo $subscribe_limit;?>"/>
</td>
</tr>

<tr>
<td class="tl">经纪人数量限制</td>
<td>
...
<td>
<input type="radio" name="setting[stats_view]" value="1" <?php if($stats_view) echo 'checked';?>> 是&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[stats_view]" value="0" <?php if(!$stats_view) echo 'checked';?>> 否
</td>
</tr>
<tr>
