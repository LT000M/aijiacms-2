...
<option value="member|logintime<<?php echo $AJ_TIME;?>-3600*24*30|email">30天未登录会员</option>
<option value="member|regtime<<?php echo $AJ_TIME;?>-3600*24*365|email">注册时间超过1年</option>
<option value="member|message>10|email">未读站内信超过10封</option>
<option value="member|money>1000|email">帐户可用<?php echo $AJ['money_name'];?>多余1000<?php echo $AJ['money_unit'];?></option>
<option value="member m,company c|m.userid=c.userid and c.vip>6|m.email"><?php echo VIP;?>指数大于6的企业</option>
<option value="member m,company c|m.userid=c.userid and c.totime><?php echo $AJ_TIME;?>|m.email"><?php echo VIP;?>服务过期的企业</option>
<option value="member m,company c|m.userid=c.userid and c.totime><?php echo $AJ_TIME;?>-3600*24*30|m.email"><?php echo VIP;?>服务30天内过期的企业</option>
