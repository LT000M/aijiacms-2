...
<td width="20"><a href="javascript:Dwidget('?moduleid=2&file=message&action=send&touser=<?php echo $v['username'];?>', '发送消息');"><img width="16" height="16" src="<?php echo AJ_SKIN;?>image/msg.gif" title="发送消息" alt=""/></a></td> 
<td width="20"><a href="javascript:Dwidget('?moduleid=2&file=sendmail&email=<?php echo $v['email'];?>', '发送邮件');"><img width="16" height="16" src="<?php echo AJ_SKIN;?>image/email.gif" title="发送邮件" alt=""/></a></td>
