...
<th>流水号</th>
<th>金额(<?php echo $AJ['money_unit'];?>)</th>
<th>模块</th>
<th>标题</th>
<th>会员名称</th>
<th>IP</th>
...
<td><a href="<?php echo AJ_PATH;?>api/redirect.php?mid=<?php echo $v['mid'];?>&itemid=<?php echo $v['tid'];?>&page=2" target="_blank"><?php echo $v['title'];?></a></td>
