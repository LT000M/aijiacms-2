...
价格：<?php echo $v['fee'] ? ($v['currency'] == 'money' ? '<span class="f_red">'.$v['fee'].$AJ['money_unit'].'/月</span>' : '<span class="f_blue">'.$v['fee'].$AJ['credit_unit'].'/月</span>') : '<span class="f_green">免费</span>';?><br/>
人气：<?php echo $v['hits'];?><br/>
收益：<span class="f_red"><?php echo $v['money'].$AJ['money_unit'];?></span>&nbsp;&nbsp;<span class="f_blue"><?php echo $v['credit'].$AJ['credit_unit'];?></span><br/>
