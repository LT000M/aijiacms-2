...
if($submit) {
	...
	$AJ['sms'] or $setting['login_sms'] = 0;
	($AJ['sms'] && $setting['login_sms']) or $setting['verify_login'] = 0;
	...
	$db->query("UPDATE {$AJ_PRE}setting SET item_value='$ext_oauth' WHERE item_key='oauth' AND item='3'");
	cache_module(3);
