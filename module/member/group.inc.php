	...
	switch($step) {
		...
		case 'refund_agree'://卖家同意买家退款
			...
			if($submit) {
				...
				$db->query("UPDATE {$table} SET status=5,editor='$_username',updatetime=$AJ_TIME,refund_reason='$content' WHERE itemid=$itemid");
