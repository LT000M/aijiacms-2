...
<table  lay-filter="table" class="layui-table" >
		<thead>
			<tr>
				...
				<th>租金 <a href="javascript:;" onclick="Dq('order','<?php echo $order == 7 ? 8 : 7;?>');"> <img src="<?php echo AJ_STATIC;?>file/image/ico-<?php echo $order == 8 ? 'asc' : ($order == 7 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
        ...
        <tr>
			...
			<th ><?php echo $v['typeid'] ? '中介' : '个人';?></th>
				...
				<th><?php echo $v['price'] ? $v['price'] : '';?>元/月</th>
