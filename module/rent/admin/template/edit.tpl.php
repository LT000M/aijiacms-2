...
<td>
  ...
  <input class="input" name="post[floor1]" type="text" size="1" value="<?php echo $floor1;?>"   /> 层 /
    ...
    <tr>
	<td>出租方式</td>
	<td><select name="post[renttype]" id="{$k}">
    <option value="1"  selected=<?php if($renttype == 1) echo 'selected';?>>整租</option>
    <option value="2" <?php if($renttype == 2) echo 'selected';?>>合租</option>
