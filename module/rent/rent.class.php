...
$status = get_status(3, $need_check);
	...
	function update($itemid) {
		...
		$update = '';
		$keyword = $item['title'].','.$item['housename'].','.$TYPE[$item['typeid']].','.strip_tags(cat_pos(get_cat($item['catid']), ','));
