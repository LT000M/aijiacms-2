...
<td class="tl">户  型</td>
<td>
<input name="post[shi]" type="text" size="2" value="<?php echo $shi;?>" id="shi"/>室
<input name="post[ting]" type="text" size="2" value="<?php echo $ting;?>" id="ting"/>厅
<input name="post[wei]" type="text" size="2" value="<?php echo $wei;?>" id="wei"/>卫
</td>
</tr>
<tr>
<td class="tl"> 建面</td>
...
<input type="radio" name="post[xszt]" value="2" <?php if($xszt == 2) echo 'checked';?>/> 预售
<input type="radio" name="post[xszt]" value="0" <?php if($xszt == 0) echo 'checked';?>/> 售罄
</td>
</tr>
<tr>
