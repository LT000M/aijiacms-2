...
<td><?php echo $_admin == 1 ? category_select('post[catid]', '选择分类', $catid, 12) : ajax_category_select('post[catid]', '选择分类', $catid, 12);?></td>
</tr>
 <tr>
...
<tr>
<td class="tl">是否推荐到楼盘封面</td>
<td>
<input type="radio" name="post[level]" value="1" <?php if($level == 1) echo 'checked';?>/> 是
<input type="radio" name="post[level]" value="0" <?php if($level == 0) echo 'checked';?>/> 否
</td>
</tr>
<tr>
