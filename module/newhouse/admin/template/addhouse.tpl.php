...
<form class="layui-form" id="info_form" action="<?php echo $MODULE[1]['linkurl'];?>api/shapan/addhouse.php"   method="post" enctype="multipart/form-data">
    <div class="layui-tab-item layui-show">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="floor_num" class="layui-input" placeholder="12">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">总户数</label>
            <div class="layui-input-inline">
                <input type="text" name="room_num" class="layui-input" placeholder="22">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">开盘时间</label>
            <div class="layui-input-inline">
                <input type="text" name="open_time" class="layui-input" placeholder="2017-12-22">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">交房时间</label>
            <div class="layui-input-inline">
                <input type="text" name="complate_time" class="layui-input" placeholder="2017-12-22" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">销售状态</label>
            <div class="layui-input-block">
                <input type="radio" name="sale_status" id="sale_status30" value="30" checked title=在售><input type="radio" name="sale_status" id="sale_status31" value="31"  title=预售><input type="radio" name="sale_status" id="sale_status32" value="32"  title=售完>            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">包含户型</label>
            <div class="layui-input-block">
                              <?php foreach($houselist as $k=>$v) { ?>
                                 <input type="checkbox" lay-skin="primary" name="huxing_id[]" value="<?php echo $v['itemid'];?>" title="<?php echo $v['shi'];?>室<?php echo $v['ting'];?>厅<?php echo $v['wei'];?>卫">
                                 <?php } ?>
