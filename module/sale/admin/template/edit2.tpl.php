...
<td>
	...
	<tr>
	<td width="70">价格</td>
	<td><input name="post[price]" type="text" size="10"  id="price" value="<?php echo $price;?>"/></td>
	</tr>
	<tr>
	<td>建筑建面</td>
	<td><input name="post[houseearm]" type="text" size="10" id="houseearm" value="<?php echo $houseearm;?>"/></td>
	</tr>
	<tr>
	<td>房    龄</td>
