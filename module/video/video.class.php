...
class video {
    ...
    function __construct($moduleid) {
		...
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','tag','album','thumb','video','mobile','width','height','status','hits','username','addtime','editor','edittime','ip','template', 'linkurl','filepath','note','houseid','housename');
    }
