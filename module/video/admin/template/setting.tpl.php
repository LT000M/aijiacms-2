...
<td><input type="text" name="setting[flvlogo]" size="30" value="<?php echo $flvlogo;?>"/><?php tips('请填写问名称，建议制作透明PNG格式，覆盖file/image/video.png');?><?php if($flvlogo) {?><br/>
<img src="file/image/<?php echo $flvlogo;?>"/><?php } ?></td>
</tr>
<tr>
