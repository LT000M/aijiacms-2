...
<tr style="display:<?php echo AJ_EDITOR == 'fckeditor' ? '' : 'none';?>">
...
<?php echo seo_title('seo_title_list', array('catname', 'cattitle', 'modulename', 'sitename', 'sitetitle', 'page', 'delimiter','areaname', 'twoareaname', 'price', 'room', 'housearea', 'toward', 'houseyear', 'floor', 'fix'));?>
</td>
</tr>
<tr>
...
<td><input type="text" size="5" name="setting[fee_add]" value="<?php echo $fee_add;?>"/> <?php echo $fee_currency == 'money' ? $AJ['money_unit'] : $AJ['credit_unit'];?>/条</td>
</tr>
<tr>
<td class="tl">查看信息收费</td>
<td><input type="text" size="5" name="setting[fee_view]" value="<?php echo $fee_view;?>"/> <?php echo $fee_currency == 'money' ? $AJ['money_unit'] : $AJ['credit_unit'];?>/条</td>
</tr>
<tr>
...
<td><input type="text" size="2" name="setting[fee_back]" value="<?php echo $fee_back;?>"/> % <?php tips('请填写1-100之间的数字，用户支付之后，系统将按此比例向发布人增加对应的'.$AJ['money_name'].'或者'.$AJ['credit_name']);?></td>
</tr>
<tr>
...
<div class="tt"><?php echo $AJ['credit_name'];?>规则</div>
<table cellspacing="0" class="tb">
<tr>
...
<tr>
<td class="tl">信息置顶扣除</td>
<td>
<input type="text" size="5" name="setting[credit_top]" value="<?php echo $credit_top;?>"/>
</td>
</tr>
<tr>
<td class="tl">火急出售扣除</td>
<td>
<input type="text" size="5" name="setting[credit_hot]" value="<?php echo $credit_hot;?>"/>
</td>
</tr>
</table>
...
<td align="right"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://www.aijiacms.com/doc/skill/94.html" target="_blank" class="t">设置说明</a></td>
</tr>
