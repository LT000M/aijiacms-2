...
<tr  id="villagenamecon">
		...
		<span class="gray9">请输入楼盘名称，如：“青园”或“qyxq”，然后在下面打开的列表中选择即可。</span>
					<div id="autoVn">
...
<tr>
<td class="tl"><span class="f_hid">*</span> 活动时间</td>
<td><?php echo dcalendar('post[endtime]', $endtime, '-', 1);?>&nbsp;
<select onchange="Dd('postendtime').value=this.value;">
