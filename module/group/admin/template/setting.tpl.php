...
<tr>
<td class="tl">下单默认模板</td>
<td><?php echo tpl_select('buy', $module, 'setting[template_buy]', '默认模板', $template_buy);?></td>
</tr>
<tr>
...
<option value="vip desc,edittime desc"<?php if($order == 'vip desc,edittime desc') echo ' selected';?>><?php echo VIP;?>级别,更新时间</option>
<option value="vip desc,addtime desc"<?php if($order == 'vip desc,addtime desc') echo ' selected';?>><?php echo VIP;?>级别,添加时间</option>
