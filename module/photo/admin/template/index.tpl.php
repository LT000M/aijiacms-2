...
<?php echo $AJ['city'] ? ajax_area_select('areaid', '不限地区', $areaid).'&nbsp;' : '';?>
<select name="open">
...
<?php } ?>
<td class="px12"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 图片列表');"><?php echo $v['items'];?></a></td>
