...
<div style="width:130px;float:left;">
	...
	<table width="120" class="ctb">
	<tr align="center" height="110" class="c_p">
	<td width="120"><img src="<?php echo AJ_SKIN?>image/waitpic.gif" width="100" height="100" id="showthumb0" title="预览图片" alt="" onclick="if(this.src.indexOf('waitpic.gif') == -1){_preview(this.src, 1);}else{Dphoto(0,<?php echo $moduleid;?>,100,100, Dd('thumb0').value, true);}"/></td>
	</tr>
	<tr align="center">
	<td height="20">
