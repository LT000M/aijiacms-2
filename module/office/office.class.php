...
class office {
    ...
    function __construct($moduleid) {
		...
		$this->fields = array('catid','mycatid','areaid','typeid','level','title','tag','style','fee','introduce','price','days','thumb','thumbs','video','thumb1','thumb2','thumb3','thumb4','tag','status','hits','username','totime','editor','addtime','adddate','edittime','editdate','ip','template','linkurl','filepath','elite','note','company','truename','telephone','mobile','address','email','msn','qq','wx','ali','skype','housename','houseid','houseearm','floor1','floor2','fenge','fitment','paytype','map','wuye','payinfo','bus','transferfee','zongjia','leibie','wuyefei','fenge');
   
		
    }

    function office($moduleid) {
