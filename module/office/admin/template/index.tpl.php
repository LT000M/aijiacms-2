...
<table  lay-filter="table" class="layui-table" >
		<thead>
			<tr>
				...
				<th>租金/价格 <a href="javascript:;" onclick="Dq('order','<?php echo $order == 7 ? 8 : 7;?>');"> <img src="<?php echo AJ_STATIC;?>file/image/ico-<?php echo $order == 8 ? 'asc' : ($order == 7 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
        ...
        <tr>
				...
				<th ><?php if($v['leibie'] == 1) echo '出租';?><?php if($v['leibie'] == 2) echo '转让';?><?php if($v['leibie'] == 3) echo '出售';?></th>
				<th ><?php echo dsubstr($v['address'], 20, $suffix = '...');?></th>
				<th ><?php echo $v['houseearm'];?>m²</th>
					<th><?php echo $v['price'] ? $v['price'] : $v['zongjia'];?><?php if($v['paytype']== 1 && $v['leibie'] ==1 ) echo '元/平米·天';?><?php if($v['paytype'] == 2) echo '元/平米·月';?><?php if($v['paytype'] == 3) echo '元/月';?><?php if($v['leibie'] == 3) echo '万元';?></th>
				
				
				<th ><?php echo $v['floor1'];?>/<?php echo $v['floor2'];?></th>
				
				
				<th ><?php echo $v['istop'] ? '置顶' : '';?>  <?php echo $v['ishot'] ? '急租' : '';?></th>
