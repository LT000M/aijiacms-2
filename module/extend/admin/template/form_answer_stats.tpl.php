...
if(swfobject.hasFlashPlayerVersion("8")) {
	swfobject.embedSWF("<?php echo AJ_PATH;?>api/amcharts/flash/ampie.swf", "chartdiv<?php echo $k;?>", "600", "400", "8.0.0", "<?php echo AJ_PATH;?>api/amcharts/flash/expressInstall.swf", flashVars, params);
} else {
