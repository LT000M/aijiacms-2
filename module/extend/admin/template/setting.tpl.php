...
<td><input name="setting[mobile_domain]" type="text" size="30" value="<?php echo $mobile_domain;?>"/><?php tips('例如 http://m.aijiacms.com/<br/>请将此域名绑定至网站mobile目录');?></td>
</tr>
<tr> 
...
<tr> 
<td class="tl">小程序首页幻灯广告位ID</td>
<td><input name="setting[xiaocx_pid]" type="text" size="5" value="<?php echo $xiaocx_pid;?>" id="xiaocx_pid"/> <a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=ad'+(Dd('xiaocx_pid').value>0 ? '&action=list&pid='+Dd('xiaocx_pid').value : ''), '幻灯广告');" class="t">[广告管理]</a> <?php tips('请建立一个幻灯广告位，并填写广告位ID，填0表示不显示幻灯广告');?></td>
</tr>
<tr>
...
<td><input name="setting[spread_domain]"  type="text" size="30" value="<?php echo $spread_domain;?>"/><?php tips('例如 http://spread.aijiacms.com/<br/>请将此域名绑定至网站spread目录');?></td>
</tr>
<tr> 
...
<td><input name="setting[ad_domain]"  type="text" size="30" value="<?php echo $ad_domain;?>"/><?php tips('例如 http://ad.aijiacms.com/<br/>请将此域名绑定至网站ad目录');?></td>
</tr>
<tr>
...
<td><input name="setting[announce_domain]"  type="text" size="30" value="<?php echo $announce_domain;?>"/><?php tips('例如 http://announce.aijiacms.com/<br/>请将此域名绑定至网站announce目录');?></td>
</tr>
</table>
...
<td><input name="setting[link_domain]"  type="text" size="30" value="<?php echo $link_domain;?>"/><?php tips('例如 http://link.aijiacms.com/<br/>请将此域名绑定至网站link目录');?></td>
</tr>
<tr>
...
<td><input name="setting[comment_domain]"  type="text" size="30" value="<?php echo $comment_domain;?>"/><?php tips('例如 http://comment.aijiacms.com/<br/>请将此域名绑定至网站comment目录');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">发布评论增加<?php echo $AJ['credit_name'];?></td>
<td>&nbsp;
<input type="text" size="5" name="setting[credit_add_comment]" value="<?php echo $credit_add_comment;?>"/>
</td>
</tr>
<tr>
<td class="tl">评论删除扣除<?php echo $AJ['credit_name'];?></td>
<td>&nbsp;
...
<a name="wenfang"></a>
<div class="tt">问房设置</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr> 
<td class="tl">问房绑定域名</td>
<td><input name="setting[wenfang_domain]"  type="text" size="30" value="<?php echo $wenfang_domain;?>"/><?php tips('例如 http://wenfang.aijiacms.com/<br/>请将此域名绑定至网站wenfang目录');?></td>
</tr>
<tr>
<td class="tl">内容页显示问房列表</td>
<td>
<input type="radio" name="setting[wenfang_show]" value="1"  <?php if($wenfang_show == 1) echo 'checked';?>> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[wenfang_show]" value="0"  <?php if($wenfang_show == 0) echo 'checked';?>> 关闭
</td>
</tr>
<tr>
<td class="tl">允许问房的模块</td>
<td><?php echo module_checkbox('setting[wenfang_module][]', $wenfang_module, '1,2,3');?></td>
</tr>
<tr>
<td class="tl">允许问房的会员组</td>
...
<td class="tl">审核问房</td>
<td>
<input type="radio" name="setting[wenfang_check]" value="2"  <?php if($wenfang_check == 2) echo 'checked';?>> 继承会员组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[wenfang_check]" value="1"  <?php if($wenfang_check == 1) echo 'checked';?>> 全部启用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[wenfang_check]" value="0"  <?php if($wenfang_check == 0) echo 'checked';?>> 全部关闭
</td>
</tr>
<tr>
<td class="tl">发布问房启用验证码</td>
<td>
<input type="radio" name="setting[wenfang_captcha_add]" value="2"  <?php if($wenfang_captcha_add == 2) echo 'checked';?>> 继承会员组设置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[wenfang_captcha_add]" value="1"  <?php if($wenfang_captcha_add == 1) echo 'checked';?>> 全部启用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[wenfang_captcha_add]" value="0"  <?php if($wenfang_captcha_add == 0) echo 'checked';?>> 全部关闭
</td>
</tr>

<tr>
<td class="tl">问房内容字数限制</td>
<td>&nbsp;
<input type="text" size="5" name="setting[wenfang_min]" value="<?php echo $wenfang_min;?>"/> 至
<input type="text" size="5" name="setting[wenfang_max]" value="<?php echo $wenfang_max;?>"/> 字节
</td>
</tr>
<tr>
<td class="tl">两次问房时间间隔</td>
<td>&nbsp;
<input type="text" size="5" name="setting[wenfang_time]" value="<?php echo $wenfang_time;?>"/> 秒
</td>
</tr>
<tr>
<td class="tl">每页显示问房个数</td>
<td>&nbsp;
<input type="text" size="5" name="setting[wenfang_pagesize]" value="<?php echo $wenfang_pagesize;?>"/> 条
</td>
</tr>
<tr>
<td class="tl">单会员或IP每日限评</td>
<td>&nbsp;
<input type="text" size="5" name="setting[wenfang_limit]" value="<?php echo $wenfang_limit;?>"/> 次
</td>
</tr>
<tr>
<td class="tl">发布问房增加<?php echo $AJ['credit_name'];?></td>
<td>&nbsp;
<input type="text" size="5" name="setting[credit_add_wenfang]" value="<?php echo $credit_add_wenfang;?>"/>
</td>
</tr>
<tr>
<td class="tl">问房删除扣除<?php echo $AJ['credit_name'];?></td>
<td>&nbsp;
<input type="text" size="5" name="setting[credit_del_wenfang]" value="<?php echo $credit_del_wenfang;?>"/>
</td>
</tr>
<tr>
<td class="tl">匿名问房昵称</td>
<td>&nbsp;
...
<td><input name="setting[guestbook_domain]"  type="text" size="30" value="<?php echo $guestbook_domain;?>"/><?php tips('例如 http://guestbook.aijiacms.com/<br/>请将此域名绑定至网站guestbook目录');?></td>
</tr>
<tr> 
<td class="tl">留言类型</td>
...
<td><input name="setting[gift_domain]"  type="text" size="30" value="<?php echo $gift_domain;?>"/><?php tips('例如 http://gift.aijiacms.com/<br/>请将此域名绑定至网站gift目录');?></td>
</tr>
</table>
...
<td><input name="setting[vote_domain]"  type="text" size="30" value="<?php echo $vote_domain;?>"/><?php tips('例如 http://vote.aijiacms.com/<br/>请将此域名绑定至网站vote目录');?></td>
</tr>
</table>
...
<td><input name="setting[poll_domain]"  type="text" size="30" value="<?php echo $poll_domain;?>"/><?php tips('例如 http://poll.aijiacms.com/<br/>请将此域名绑定至网站poll目录');?></td>
</tr>
</table>
...
<td><input name="setting[form_domain]"  type="text" size="30" value="<?php echo $form_domain;?>"/><?php tips('例如 http://form.aijiacms.com/<br/>请将此域名绑定至网站form目录');?></td>
</tr>
</table>
...
<td><input name="setting[archiver_domain]"  type="text" size="30" value="<?php echo $archiver_domain;?>"/><?php tips('例如 http://archiver.aijiacms.com/<br/>请将此域名绑定至网站archiver目录');?></td>
</tr>
</table>
...
<td><input name="setting[feed_domain]"  type="text" size="30" value="<?php echo $feed_domain;?>"/><?php tips('例如 http://feed.aijiacms.com/<br/>请将此域名绑定至网站feed目录');?></td>
</tr>
<tr> 
...
<tr>
<td class="tl">上次更新</td>
<td><?php echo timetodate(filemtime(AJ_ROOT.'/sitemaps.xml'));?>&nbsp;&nbsp; <a href="?moduleid=<?php echo $moduleid;?>&file=sitemap&action=sitemaps" class="t">立即更新</a></td>
</tr>
<tr>
<td class="tl">详细了解Sitemaps?</td>
<td><a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://www.google.com/support/webmasters/bin/topic.py?topic=8476" target="_blank">http://www.google.com/support/webmasters/bin/topic.py?topic=8476</a></td>
</tr>
</table>
</div>
...
<tr>
<td class="tl">上次更新</td>
<td><?php echo timetodate(filemtime(AJ_ROOT.'/baidunews.xml'));?>&nbsp;&nbsp; <a href="?moduleid=<?php echo $moduleid;?>&file=sitemap&action=baidunews" class="t">立即更新</a></td>
</tr>
<tr>
<td class="tl">详细了解百度新闻?</td>
<td><a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://news.baidu.com/newsop.html" target="_blank">http://news.baidu.com/newsop.html</a></td>
</tr>
</table>
</div>
<div class="sbt">
