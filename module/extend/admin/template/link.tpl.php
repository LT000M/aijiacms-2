...
<td><a href="<?php echo AJ_PATH;?>api/redirect.php?url=<?php echo urlencode($v['linkurl']);?>" target="_blank"><?php echo $v['title'];?></td>
<td><?php if($v['thumb']) {?><a href="<?php echo AJ_PATH;?>api/redirect.php?url=<?php echo urlencode($v['linkurl']);?>" target="_blank"><img src="<?php echo $v['thumb'];?>" width="88" /><?php } ?></a></td>
