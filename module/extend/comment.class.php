...
class comment {
    ...
    function __construct() {
		$this->table = AJ_PRE.'comment';
		$this->table_stat = AJ_PRE.'comment_stat';
		$this->table_ban = AJ_PRE.'comment_ban';
    }
	...
	function set($post) {
		...
		if($post['reply']) $post['replytime'] = AJ_TIME;
	...
	function _add($post) {
		...
		DB::query("INSERT INTO {$this->table_ban} (moduleid,itemid,editor,edittime) VALUES('$post[moduleid]','$post[itemid]','$_username','".AJ_TIME."')");
	}
