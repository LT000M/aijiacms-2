...
<block name="content">
    ...
    <form class="layui-form" action="" method="post" style="margin-top: 10px;">
        ...
        <div class="layui-inline">
            <label class="layui-form-label" style="color: #f00;width: 120px;">现维护人：</label>
            <div class="layui-input-inline" style="width:160px;">
                <div class="layui-form-select choice-user-div">
                    <div class="layui-select-title">
                        <input type="text" name="username" placeholder="请输入电话或拼音" class="layui-input choice-user-input" lay-verify="required" autocomplete="off">
                        <input type="hidden" name="weihurenid" class="choice-userid-input" lay-verify="required">
                        <i class="layui-edge"></i>
                    </div>
                    <dl class="layui-anim layui-anim-upbit choice-user-dl" style="">
                        <dd lay-value="" class="layui-select-tips">请输入电话或拼音</dd>
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate'], function(){
            ...
            form.on('submit(demo1)', function(data){
                $.ajax({
                    url:'<?php echo $MODULE[1][linkurl];?>api/keyuan/bgwhr.php',
                    type:"post",
                    data:data.field,
                    dataType:"json",
                    success: function(data){
