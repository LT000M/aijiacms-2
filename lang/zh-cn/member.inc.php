...
$L['credit_not_enough'] = '您的'.$AJ['credit_name'].'不足，请购买';
$L['pay_in_site'] = '站内支付';
$L['in_site'] = '站内';
$L['month'] = '月';
$L['forever'] = '永久';
...
$L['cash_msg_success'] = '您的提现申请已经提交，请等待工作人员的处理<br/>在此期间，该笔'.$AJ['money_name'].'将被冻结';
...
$L['credit_exchange_title'] = $AJ['credit_name'].'兑换';
$L['credit_buy_title'] = $AJ['credit_name'].'购买';
$L['credit_title'] = $AJ['credit_name'].'记录';
...
$L['grade_msg_money_promo'] = '可充抵金额:{V0}'.$AJ['money_unit'];
...
$L['invite_title'] = $AJ['credit_name'].'推广';
...
$L['mail_msg_not_add'] = '您尚未订阅任何房源';
$L['mail_msg_cancel'] = '退订成功';
$L['mail_msg_update'] = '订阅更新成功';
$L['mail_msg_choose'] = '请选择房源分类，如果要取消订阅，请直接点击退订按钮';
...
$L['record_title'] = $AJ['money_name'].'流水';
...
$L['register_msg_activate'] = $AJ['sitename'].'用户注册激活信';
$L['register_msg_welcome'] = '欢迎加入'.$AJ['sitename'];
$L['register_pass_groupid'] = '请选择会员组';
$L['register_msg_emailcode'] = $AJ['sitename'].'用户邮件验证码';
...
$L['send_password_mail'] = $AJ['sitename'].'用户找回密码';
...
$L['validate_email_mail'] = $AJ['sitename'].'用户邮件认证';
