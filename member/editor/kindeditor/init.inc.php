...
if($toolbarset == 'Aijiacms') {
	$editor .= "items : [".(defined('AJ_ADMIN') ? "'source', '|', " : "")."'wordpaste', 'plainpaste', '|', 'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'image', 'multiimage', 'media', 'hr', 'justifyleft', 'justifycenter', 'justifyright', 'insertfile', ".($MODULE[$moduleid]['module'] == 'club' ? "'emoticons', " : "")."'fullscreen'],";
} else if($toolbarset == 'Simple') {
	$editor .= "items : [".(defined('AJ_ADMIN') ? "'source', '|', " : "")."'wordpaste', 'plainpaste', '|', 'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'image', 'justifyleft', 'justifycenter', 'justifyright', 'insertfile', ".($MODULE[$moduleid]['module'] == 'club' ? "'emoticons', " : "")."'fullscreen'],";
} else if($toolbarset == 'Basic') {
	$editor .= "items : [".(defined('AJ_ADMIN') ? "'source', '|', " : "")."'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'image', 'justifyleft', 'justifycenter', 'justifyright', ".($MODULE[$moduleid]['module'] == 'club' ? "'emoticons', " : "")."'fullscreen'],";
} else if($toolbarset == 'Message') {
	$editor .= "items : [".(defined('AJ_ADMIN') ? "'source', '|', " : "")."'wordpaste', 'plainpaste', '|', 'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'image', 'emoticons', 'justifyleft', 'justifycenter', 'justifyright', 'insertfile', ".($MODULE[$moduleid]['module'] == 'club' ? "'emoticons', " : "")."'fullscreen'],";
} else {
