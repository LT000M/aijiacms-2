...
FCKConfig.ToolbarSets["Aijiacms"] = [
...
if(!IsAdmin) FCKConfig.ToolbarSets["Aijiacms"][0].splice(0,2);
if(window.parent.ModuleID == 18) FCKConfig.ToolbarSets["Aijiacms"][0].splice(-1,0,'Smiley');
