...
if($AJ_MOB['browser'] == 'weixin' && $EXT['weixin']) dheader(AJ_MOB.'api/weixin.php?action=connect');
...
<body>
	<div style="width:100%;text-align:center;padding-top:30px;">
		...
		<?php if(AJ_TOUCH) { ?>
		<a href="http://app.aijiacms.com/scan/" rel="external" style="color:#2E7DC6;text-decoration:none;">如何扫描？</a>&nbsp;&nbsp;|&nbsp;&nbsp;
		<?php } ?>
