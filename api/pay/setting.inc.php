...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.alipay.com" target="_blank"><strong>支付宝 Alipay</strong></a></td>
<td>
<input type="radio" name="pay[alipay][enable]" value="1"  <?php if($alipay['enable']) echo 'checked';?> onclick="Dd('alipay').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[alipay][enable]" value="0"  <?php if(!$alipay['enable']) echo 'checked';?> onclick="Dd('alipay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://b.alipay.com/signing/productDetail.htm?productId=I1011000290000001000" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.alipay.com" target="_blank"><strong>支付宝手机支付 Alipay</strong></a></td>
<td>
<input type="radio" name="pay[aliwap][enable]" value="1"  <?php if($aliwap['enable']) echo 'checked';?> onclick="Dd('aliwap').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[aliwap][enable]" value="0"  <?php if(!$aliwap['enable']) echo 'checked';?> onclick="Dd('aliwap').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://b.alipay.com/signing/productDetail.htm?productId=I1011000290000001001" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://pay.weixin.qq.com/" target="_blank"><strong>微信支付 Weixin</strong></a></td>
<td>
<input type="radio" name="pay[weixin][enable]" value="1"  <?php if($weixin['enable']) echo 'checked';?> onclick="Dd('weixin').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[weixin][enable]" value="0"  <?php if(!$weixin['enable']) echo 'checked';?> onclick="Dd('weixin').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://kf.qq.com/faq/120911VrYVrA150906yUZze6.html" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl">交易密钥</td>
<td><input type="text" size="60" name="pay[weixin][keycode]" value="<?php echo $weixin['keycode'];?>" onfocus="if(this.value.indexOf('**')!=-1)this.value='';"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://pay.weixin.qq.com/index.php/account/api_cert" target="_blank" class="t">[密钥设置]</a></td>
</tr>
<tr>
<td class="tl">接收服务器通知文件名</td>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.tenpay.com" target="_blank"><strong>财付通 TenPay</strong></a></td>
<td>
<input type="radio" name="pay[tenpay][enable]" value="1"  <?php if($tenpay['enable']) echo 'checked';?> onclick="Dd('tenpay').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[tenpay][enable]" value="0"  <?php if(!$tenpay['enable']) echo 'checked';?> onclick="Dd('tenpay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://mch.tenpay.com/market/opentrans_immediately.shtml" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://cn.unionpay.com/" target="_blank"><strong>中国银联 UnionPay</strong></a></td>
<td>
<input type="radio" name="pay[upay][enable]" value="1"  <?php if($upay['enable']) echo 'checked';?> onclick="Dd('upay').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[upay][enable]" value="0"  <?php if(!$upay['enable']) echo 'checked';?> onclick="Dd('upay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://open.unionpay.com/ajweb/product/detail?id=1" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.chinabank.com.cn" target="_blank"><strong>网银在线 ChinaBank</strong></a></td>
<td>
...
<input type="radio" name="pay[chinabank][enable]" value="0"  <?php if(!$chinabank['enable']) echo 'checked';?> onclick="Dd('chinabank').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://www.chinabank.com.cn/product/payment_gateway.jsp" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.yeepay.com" target="_blank"><strong>易宝支付 YeePay</strong></a></td>
<td>
<input type="radio" name="pay[yeepay][enable]" value="1"  <?php if($yeepay['enable']) echo 'checked';?> onclick="Dd('yeepay').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[yeepay][enable]" value="0"  <?php if(!$yeepay['enable']) echo 'checked';?> onclick="Dd('yeepay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://www.yeepay.com/productCenter/internetBankingPayment" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.99bill.com" target="_blank"><strong>快钱支付 99bill</strong></a></td>
<td>
...
<input type="radio" name="pay[kq99bill][enable]" value="0"  <?php if(!$kq99bill['enable']) echo 'checked';?> onclick="Dd('kq99bill').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://www.99bill.com/z/pay_net_bank.html" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.chinapay.com" target="_blank"><strong>银联在线 ChinaPay</strong></a></td>
<td>
...
<input type="radio" name="pay[chinapay][enable]" value="0"  <?php if(!$chinapay['enable']) echo 'checked';?> onclick="Dd('chinapay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://www.chinapay.com/web2016/concern/index.jsp" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.paypal.com" target="_blank"><strong>贝&nbsp;&nbsp;&nbsp;宝 PayPal</strong></a></td>
<td>
<input type="radio" name="pay[paypal][enable]" value="1"  <?php if($paypal['enable']) echo 'checked';?> onclick="Dd('paypal').style.display='';"/> 启用&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="pay[paypal][enable]" value="0"  <?php if(!$paypal['enable']) echo 'checked';?> onclick="Dd('paypal').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo AJ_PATH;?>api/redirect.php?url=www.paypal.com" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
