...
function uc_user_regbbs($uid, $username, $password, $email) {//DT ADD
	return call_user_func(UC_API_FUNC, 'user', 'regbbs', array('uid'=>$uid, 'username'=>$username, 'password'=>$password, 'email'=>$email));
}
