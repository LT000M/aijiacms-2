...
function changeDIV(id) {
    if (id == "1") {
        ID('title01').className = "maintitletd1";
        ID('title02').className = "maintitletda font01";
        ID('title03').className = "maintitletdb font01";
        ID('title04').className = "maintitletda font01";
        ID('title05').className = "maintitletd font01";
    } else if (id == "2") {
        ID('title01').className = "maintitletd font01";
        ID('title02').className = "maintitletda1";
        ID('title03').className = "maintitletdb font01";
        ID('title04').className = "maintitletda font01";
        ID('title05').className = "maintitletd font01";
    } else if (id == "3") {
        ID('title01').className = "maintitletd font01";
        ID('title02').className = "maintitletda font01";
        ID('title03').className = "maintitletdb1";
        ID('title04').className = "maintitletda font01";
        ID('title05').className = "maintitletd font01";
    } else if (id == "4") {
        ID('title01').className = "maintitletd font01";
        ID('title02').className = "maintitletda font01";
        ID('title03').className = "maintitletdb font01";
        ID('title04').className = "maintitletda1";
        ID('title05').className = "maintitletd font01";
    } else if (id == "5") {
        ID('title01').className = "maintitletd font01";
        ID('title02').className = "maintitletda font01";
        ID('title03').className = "maintitletdb font01";
        ID('title04').className = "maintitletda font01";
        ID('title05').className = "maintitletd1";
    }
    for (var i = 1; i < 6; i++) {
        if (ID('calculate0' + i) != null) {
            ID('calculate0' + i).style.display = "none";
        }
        if (ID('note0' + i) != null) {
            ID('note0' + i).style.display = "none";
        }
    }
    ID('calculate0' + id).style.display = "block";
    ID('note0' + id).style.display = "block";
}
...
lilv_array[5][1][10] = 0.0655;//商贷 5-30年 5.75%
...
lilv_array[32][1][5] = 0.06;//商贷 1～5年 

lilv_array[32][1][10] = 0.0615;//商贷 5-30年

lilv_array[32][2][5] = 0.0375;//公积金 1～5年 

lilv_array[32][2][10] = 0.0425;//公积金 5-30年 
...
lilv_array[33][1][5] = 0.0575;//商贷 1～5年 

lilv_array[33][1][10] = 0.059;//商贷 5-30年

lilv_array[33][2][5] = 0.035;//公积金 1～5年 

lilv_array[33][2][10] = 0.04;//公积金 5-30年 
...
lilv_array[34][1][1] = 0.051;//商贷 1年 

lilv_array[34][1][5] = 0.055;//商贷 1～5年 

lilv_array[34][1][10] = 0.0565;//商贷 5-30年

lilv_array[34][2][5] = 0.0325;//公积金 1～5年 

lilv_array[34][2][10] = 0.0375;//公积金 5-30年 
...
lilv_array[35][1][1] = 0.0485;//商贷 1年 

lilv_array[35][1][5] = 0.0525;//商贷 1～5年 

lilv_array[35][1][10] = 0.054;//商贷 5-30年

lilv_array[35][2][5] = 0.03;//公积金 1～5年 

lilv_array[35][2][10] = 0.035;//公积金 5-30年 
...
lilv_array[36][1][1] = 0.046;//商贷 1年 

lilv_array[36][1][5] = 0.05;//商贷 1～5年 

lilv_array[36][1][10] = 0.0515;//商贷 5-30年

lilv_array[36][2][5] = 0.0275;//公积金 1～5年 

lilv_array[36][2][10] = 0.0325;//公积金 5-30年 

// 15年10月24日基准利率
lilv_array[37] = new Array;
lilv_array[37][1] = new Array;
lilv_array[37][2] = new Array;
lilv_array[37][1][1] = 0.0435;//商贷 1年
lilv_array[37][1][3] = 0.0435;//商贷 1-3年 
lilv_array[37][1][5] = 0.0475;//商贷 3～5年 
lilv_array[37][1][10] = 0.049;//商贷 5-30年
lilv_array[37][2][5] = 0.0275;//公积金 1～5年 
lilv_array[37][2][10] = 0.0325;//公积金 5-30年


//页面默认显示最新贷款利率为：显示商贷5-30年的和公积金5-30年
//ID("new_sdlv").innerHTML = myround(0.049 * 100, 2);//商贷 5-30年
//ID("new_gjlv").innerHTML = myround(0.0325 * 100, 2);//公积金 5-30年

//页面显示年利率下拉选项
for (i = 1; i < 5; i++) {
    var html = '<option value="31">12年7月6日利率上限（1.1倍）</option>\n\
                            <option value="30">12年7月6日利率下限（85折）</option>\n\
                            <option value="29">12年7月6日利率下限（7折）</option>\n\
                            <option value="28" >12年7月6日基准利率</option>\n\
                            ...
                            <option value="8">2014年1月1日利率上限（1.1倍）</option>\n\
                            <option value="7">2014年1月1日利率下限（85折）</option>\n\
                            <option value="6">2014年1月1日利率下限（7折）</option>\n\
                            <option value="5">2014年1月1日基准利率</option>\n\
                            <option value="32">2014年9月30日基准利率</option>\n\
                            <option value="33">2015年3月1日基准利率</option>\n\
                            <option value="34">2015年5月10日基准利率</option>\n\
                            <option value="35">2015年6月28日基准利率</option>\n\
                            <option value="36">2015年8月26日基准利率</option>\n\
                            <option value="37" selected="selected">15年10月24日基准利率</option>';
    $("#lilv" + i).append(html);


    // var eobj = ID("lilv"+i);
    // if(eobj){
    // eobj.innerHTML = '<option value="31">12年7月6日利率上限（1.1倍）</option>\n\
    // <option value="30">12年7月6日利率下限（85折）</option>\n\
    // <option value="29">12年7月6日利率下限（7折）</option>\n\
    // <option value="28" >12年7月6日基准利率</option>\n\
    // <option value="27">12年6月8日利率上限（1.1倍）</option>\n\
    ...
    // <option value="33">2015年3月1日基准利率</option>\n\
    // <option value="34">2015年5月10日基准利率</option>\n\
    // <option value="35" selected="selected">2015年6月28日基准利率</option>';
    // }
}
...
function ShowLilv(month, lt) {
    var yeargjj = (month > 5) ? 10 : 5;
    var year;
    if (month > 5) {
        year = 10;
    } else if (month < 2 && (lt == 34 || lt == 35 || lt == 36)) {
        year = 1;
    } else {
        year = 5;
    }
    ID("sdlv2").innerHTML = myround(lilv_array[lt][1][year] * 100, 2);
    ID("gjlv2").innerHTML = myround(lilv_array[lt][2][yeargjj] * 100, 2);
}

function ShowLilvsd(month, lt) {
    var year;
    if (month > 5) {
        year = 10;
    } else if (month < 2 && (lt == 34 || lt == 35 || lt == 36)) {
    ...
    ID("sdlv").innerHTML = myround(lilv_array[lt][1][year] * 100, 2);
}

function reset_back(num) {
    if (num == 0) {
        ID("gjlv").innerHTML = 3.25;
        ID("sdlv").innerHTML = 4.9;
    } else {
        ID("gjlv" + num).innerHTML = 3.25;
        ID("sdlv" + num).innerHTML = 4.9;
    }
}


function ShowLilvgj(month, lt) {
    var year = (month > 5) ? 10 : 5;
    ID("gjlv").innerHTML = myround(lilv_array[lt][2][year] * 100, 2);
}
...
function exc_zuhe(fmobj, v) {
    ...
    if (fmobj.name == "calc1") {
        if (v == 3) {
            ID("calc1_zuhe").style.display = 'block';
            ID("calc1_ctype").style.display = 'none';
            fmobj.jisuan_radio[1].checked = true;
            exc_js(fmobj, 2);
        } else {
            ID("calc1_zuhe").style.display = 'none';
            ID("calc1_ctype").style.display = 'block';
        }
    } else {
        if (v == 3) {
            ID("calc2_zuhe").style.display = 'block';
            fmobj.jisuan_radio[1].checked = true;
            exc_js(fmobj, 2);
        } else {
            ID("calc2_zuhe").style.display = 'none';
        }
    }
}
...
function ext_total(fmobj) {
    ...
    if (fmobj.type.value == 3) {
        ...
        for (j = 0; j < month; j++) {
            ...
            fmobj.month_money2.options[j] = new Option((j + 1) + "期," + huankuan + "(元)", huankuan);
        ...
        if (fmobj.jisuan_radio[1].checked == true) {
            //------------ 根据单价建面计算
        ...
        //支付利息款
        fmobj.accrual1.value = Math.round((all_total1 - daikuan_total) * 100) / 100;
        //ID('button4').style.display = "block";

    }
    /*if(ID("dengeben2").checked){
...
function chanage_type_mm() {
    if (ID("dengeben2").checked)
        ID("type1_mm1").innerHTML = '&nbsp;&nbsp;月均金额：<textarea name="month_money1" rows="5" ></textarea>';
    else
        ID("type1_mm1").innerHTML = '&nbsp;&nbsp;月均还款：<input name="month_money1" type="text" class="guestbook02" />元';
}

//提前还歀计算
function play() {
    var bfhk = ID('bfhk').style.display;
    var tqhkfs = '';
    if (bfhk == 'block') {
        tqhkfs = true;
    } else {
    ...
    if (tqhkfs && document.tqhdjsq.tqhkws.value == '') {
        alert('请填入部分提前还款额度');
        return;
    }
...
function c_id_card(obj) {
    ...
    if (id_card.length > 0) {
        ...
        if (id_card.length != 15 && id_card.length != 18) {
            alert('身份证号码长度为15或18位');
            return false;
        }
        if (!isIdCardNo(id_card)) {
            alert('请输入正确的身份证号码');
            return false;
        }
        var a = new Date();
        ...
        if (id_card.length == 15) {
            age = y - Number('19' + id_card.substr(6, 2));
        } else {
            age = y - Number(id_card.substr(6, 4));
        }
        var max_qx = 70 - age;
        if (max_qx > 30) {
            max_qx = 30;
...
//obj.ze2.value=gjjdka; //jtysr;
    obj.ze2.value = Math.floor(Math.min(gjjdkb, gjjdkc) / 10000 * 10) / 10 + ' 万元';
...
//alert(dknx);
    ...
    jtysr = Math.ceil((gryjce / grjcbl + poyjce / pojcbl) * 10) / 10;//家庭月收入
...
//计算2
    ...
    dked = Math.round(obj.need.value * 10) / 10;//贷款额度
...
function chk02() {
    if (parseFloat(document.formjsq.gfzc.value) > parseFloat(document.formjsq.jtysr.value) * 0.7) {
        alert("您预计家庭每月可用于购房支出已超过家庭月收入的70%，" + "\n\n" + "是否确定不会影响您的正常生活消费？" + "\n\n" + "建议在40%（" + parseFloat(document.formjsq.jtysr.value) * 0.4 + "元）左右")
    }
}
...
function chk03() {
    if (document.myform.rg01.value == "")
        alert("请填写现可用于购房的资金")
    else if (document.myform.rg02.value == "")
        alert("请填写现家庭月收入")
    else if (document.myform.rg03.value == "")
        alert("请填写预计家庭每月可用于购房支出")
    else if (document.myform.rg06.value == "")
        alert("请填写您计划购买房屋的建面")
    else
        chk04()
...
//您可购买的房屋总价=（家庭月收入-家庭月固定支出）×( (（1＋月利率）＾还款月数)－1  )÷［月利率×（1＋月利率）＾还款月数］+持有资金 
    ...
    js03 = parseFloat(document.myform.rg06.value);//建面
...
function pl() {
    ...
    XmlHttp.open("POST", "/newhouse_calculateTool_projList.php?s=" + Math.random() + "&city=" + encodeURIComponent(ID('abcity').value) + "&price=" + Math.round(document.myform.rg08.value), false);
    XmlHttp.send(null);
    if (XmlHttp.status == 200) {
        ID('projList').innerHTML = XmlHttp.responseText;
    }
}

function closeCityList() {
    if (ID('searchExpert2').style.display != "none") ID('searchExpert2').style.display = 'none';
}

function ChangeCity(city) {
    ID('abcity').value = city;
    ID('showcity').innerHTML = city;
    closeCityList()
}


$('input[name="xz"]').on('click',function(e){
    var el = $(e.currentTarget);
    $('input[name="xz"]').parent().removeClass('cur');
    el.parent().addClass('cur');
    console.log(el.prop('checked'));
})

$('input[name="xy"]').on('click',function(e){
    var el = $(e.currentTarget);
    $('input[name="xy"]').parent().removeClass('cur');
    el.parent().addClass('cur');
    console.log(el.prop('checked'));
})

$('input[name="clfs"]').on('click',function(e){
    var el = $(e.currentTarget);
    $('input[name="clfs"]').parent().removeClass('cur');
    el.parent().addClass('cur');
    console.log(el.prop('checked'));
})