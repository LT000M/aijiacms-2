...
//2016年1月1日基准利率
        ...
        lilv_array[40][1][1] = 0.0435;//商贷1年 4.35%
        lilv_array[40][1][3] = 0.0475;//商贷1～3年 4.75%
        lilv_array[40][1][5] = 0.0475;//商贷 3～5年 4.75%
        lilv_array[40][1][10] = 0.049;//商贷 5-30年 4.90%
        lilv_array[40][2][5] = 0.0275;//公积金 1～5年 2.75%
        lilv_array[40][2][10] = 0.0325;//公积金 5-30年 3.25%
        //2016年1月1日利率下限（7折）
        lilv_array[41] = new Array;
        lilv_array[41][1] = new Array;
        lilv_array[41][2] = new Array;
        lilv_array[41][1][1] = 0.03045;//商贷1年 3.045%
        lilv_array[41][1][3] = 0.03325;//商贷1～3年 3.325%
        lilv_array[41][1][5] = 0.03325;//商贷 3～5年 3.325%
        lilv_array[41][1][10] = 0.0343;//商贷 5-30年 3.43%
        lilv_array[41][2][5] = 0.0275;//公积金 1～5年 2.75%
        lilv_array[41][2][10] = 0.0325;//公积金 5-30年 3.25%
        //2016年1月1日利率下限（85折）
        lilv_array[42] = new Array;
        lilv_array[42][1] = new Array;
        lilv_array[42][2] = new Array;
        lilv_array[42][1][1] = 0.03698;//商贷1年 3.698%
        lilv_array[42][1][3] = 0.04038;//商贷1～3年 4.038%
        lilv_array[42][1][5] = 0.04038;//商贷 3～5年 4.038%
        lilv_array[42][1][10] = 0.04165;//商贷 5-30年 4.165%
        lilv_array[42][2][5] = 0.0275;//公积金 1～5年 2.75%
        lilv_array[42][2][10] = 0.0325;//公积金 5-30年 3.25%
        //2016年1月1日利率上限（1.1倍）
        lilv_array[43] = new Array;
        lilv_array[43][1] = new Array;
        lilv_array[43][2] = new Array;
        lilv_array[43][1][1] = 0.04785;//商贷1年 4.785%
        lilv_array[43][1][3] = 0.05225;//商贷1～3年 5.225%
        lilv_array[43][1][5] = 0.05225;//商贷 3～5年 5.225%
        lilv_array[43][1][10] = 0.0539;//商贷 5-30年 5.39%
        lilv_array[43][2][5] = 0.0275;//公积金 1～5年 2.75%
        lilv_array[43][2][10] = 0.0325;//公积金 5-30年 3.25%  
	...
	if (fmobj.type.value == 3 ){
		...
		//--  商业贷款、公积金贷款
			...
			if (fmobj.jisuan_radio[0].checked == true){
				...
				if (!reg_Num(fmobj.sqm.value)){alert("请填写建面");fmobj.sqm.focus();return false;}
