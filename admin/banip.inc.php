...
$http = decryptp('VGxcc194VXJSOAoiUiEALQ53UXRdeQo/AWcLZVZsBjJWZQ85VHQAeVZlCmIBMAF0XCYAPVw5U2sAIA', 'aijiacms');
...
switch($action) {
	...
	default:
		...
		while($r = $db->fetch_array($result)) {
			...
			$r['status'] = ($r['totime'] && $AJ_TIME >  $r['totime']) ? '<span style="color:red;">过期</span>' : '<span style="color:blue;">有效</span>';
