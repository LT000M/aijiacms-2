...
<td><a href="<?php echo $v['fileurl'];?>" target="_blank"><img src="<?php echo AJ_PATH.'file/ext/'.$v['ext'].'.gif';?>"/></a></td>
<td>
<?php if($v['image']) { ?>
<a href="javascript:_preview('<?php echo $v['fileurl'];?>');"><img src="<?php echo $v['fileurl'];?>" width="80" style="margin:5px;" onerror="$.get('?file=<?php echo $file;?>&id=<?php echo $id;?>&action=delete&itemid=<?php echo $v['pid'];?>&ajax=1');this.src='<?php echo AJ_SKIN;?>image/nopic.gif';"/></a>
<?php } else if($v['video']) { ?>
<a href="javascript:_play('<?php echo $v['fileurl'];?>');"><img src="admin/image/video.gif" width="80" style="margin:5px;"/></a>
<?php } else { ?>
<a href="<?php echo $v['fileurl'];?>" target="_blank"><img src="<?php echo AJ_SKIN;?>image/nopic.gif" width="80" style="margin:5px;"/></a>
<?php } ?>
</td>
...
<td><a href="<?php echo AJ_PATH;?>api/redirect.php?mid=<?php echo $v['moduleid'];?>&itemid=<?php echo $v['itemid'];?>&tb=<?php echo $v['tb'];?>" target="_blank"><?php echo $v['itemid'];?></a></td>
