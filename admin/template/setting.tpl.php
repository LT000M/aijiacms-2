...
<tr>
<td class="tl">网站地址</td>
<td><input name="config[url]" type="text" value="<?php echo $url;?>" size="40"/><?php tips('请添写完整URL地址,例如https://www.aijiacms.com/<br/>注意以 / 结尾');?></td>
</tr>
<tr>
<td class="tl">网站LOGO</td>
<td><input name="setting[logo]" type="text" value="<?php echo $logo;?>" id="logo" size="58"/> <span onclick="Dthumb(1,180,50, Dd('logo').value, 0, 'logo');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="if(Dd('logo').value){Dd('showlogo').src=Dd('logo').value;}" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('logo').value='';Dd('showlogo').src='<?php echo AJ_SKIN;?>image/logo.gif';" class="jt">[删除]</span><br/>
...
<td><input name="setting[wxlogo]" type="text" value="<?php echo $wxlogo;?>" id="wxlogo" size="58"/> <span onclick="Dthumb(1,122,122, Dd('wxlogo').value, 0, 'wxlogo');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="if(Dd('wxlogo').value){Dd('showwxlogo').src=Dd('wxlogo').value;}" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('wxlogo').value='';Dd('showwxlogo').src='<?php echo AJ_SKIN;?>image/wxlogo.gif';" class="jt">[删除]</span><br/>
<a href="<?php echo AJ_PATH;?>" target="_blank"><img src="<?php echo $wxlogo ? $wxlogo : AJ_PATH.'/api/weixin/image/qrcode.png';?>"  width="122" height="122" style="margin:2px;" id="showwxlogo"/></a></td>
</tr>

<tr>
<td class="tl">网站H5域名 </td>
<td><input name="setting[hdomain]" type="text" value="<?php echo $hdomain;?>" size="40"/><?php tips('请添写完整URL地址,例如https://www.aijiacms.com/h5<br/>注意以 / 结尾');?></td>
</tr>
<tr>
<td class="tl">房源分享背景</td>
<td><input name="setting[house_poster_bg]" type="text" value="<?php echo $house_poster_bg;?>" id="house_poster_bg" size="58"/> <span onclick="Dthumb(1,680,1060, Dd('house_poster_bg').value, 0, 'house_poster_bg');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="if(Dd('house_poster_bg').value){Dd('showhouse_poster_bg').src=Dd('house_poster_bg').value;}" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('house_poster_bg').value='';Dd('showhouse_poster_bg').src='';" class="jt">[删除]</span><br/>
<a href="<?php echo AJ_PATH;?>" target="_blank"><img src="<?php echo $house_poster_bg ? $house_poster_bg : '';?>" style="margin:2px;" id="showlogo"/></a></td>
</tr>
<tr>
<td class="tl">版权信息</td>
...
<tr>
<td class="tl">手机版统计</td>
<td><textarea name="setting[wapcount]" id="wapcount" style="width:500px;height:50px;"><?php echo $wapcount;?></textarea><br/>支持HTML语法，常用代码  
</td> 
</tr>
<tr>
<td class="tl">客服电话</td>
...
foreach($dirs as $v) {
	if(is_dir(AJ_ROOT.'/template/'.$v['dir'].'/mobile/')) continue;
...
foreach($dirs as $v) {
	$selected = ($AJ['map'] && $v['dir'] == $AJ['map']) ? 'selected' : '';
	$select .= "<option value='".$v['dir']."' ".$selected.">".$v['name']."</option>";
}
$select = '<select name="setting[map]">'.$select.'</select>';
echo $select;
...
<tr>
<td class="tl">地图坐标设置</td>
<td><input name="setting[map_mid]" type="text" value="<?php echo $map_mid;?>" size="35"/><?php tips('如果开启城市分站，该功能无效。');?><a href="http://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank">拾取地图坐标</a></td>
</tr>

<tr>
<td class="tl">地图密匙</td>
<td><input name="setting[map_key]" type="text" id="map_key" value="<?php echo $map_key;?>" size="50"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://lbsyun.baidu.com/index.php?title=androidsdk/guide/key" target="_blank" class="t">[百度地图key]</a></td> 
</tr>
...
<td><input name="config[com_domain]" type="text" value="<?php echo $com_domain;?>" size="30"/> <?php tips('如果填写 .aijiacms.com 同时需要将域名泛解析 *.aijiacms.com 指向服务器IP，并且在服务器端绑定泛域名至 网站根目录 或者 网站根目录/company 目录，生成的主页形式为username.aijiacms.com<br/>如果填写 i.aijiacms.com 同时需要将域名泛解析 i.aijiacms.com 指向服务器IP，并且在服务器端绑定域名至网站根目录/company 目录，生成的主页形式为i.aijiacms.com/username/(注：此方式必须支持伪静态)');?></td>
</tr>
<tr>
...
<input type="radio" name="setting[com_www]" value="0"  <?php if(!$com_www){ ?>checked <?php } ?>/> 关闭 <?php tips('例如二级域名为sell.aijiacms.com<br/>添加www后为 www.sell.aijiacms.com');?>
</td>
</tr>
<tr>
...
<td class="tl">流量统计</td>
<td>
<input type="radio" name="setting[stats]" value="1" <?php if($stats){ ?>checked <?php } ?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[stats]" value="0" <?php if(!$stats){ ?>checked <?php } ?>/> 关闭 <?php tips('开启此项会增加访问量大的站点的服务器负担');?></td>
</tr>
<tr>
<td class="tl">积分记录</td>
<td>
...
<?php }?>
<tr>
<td class="tl">FTP文件接口</td>
<td>
<input type="radio" name="setting[gl_ftptype]" value="0"  <?php if($gl_ftptype==0){ ?>checked <?php } ?> /> 默认&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[gl_ftptype]" value="1"  <?php if($gl_ftptype==1){ ?>checked <?php } ?> /> 阿里云OSS&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[gl_ftptype]" value="2"  <?php if($gl_ftptype==2){ ?>checked <?php } ?> /> 七牛<?php tips('开启远程文件上传后，所有上传文件将被FTP移动到远程服务器上，可以极大的缓解主站流量压力');?></td>
</tr>
<tr> 
...
<td><input name="setting[remote_url]" id="ftp_remote_url" type="text" value="<?php echo $remote_url;?>" size="60"/><?php tips('例如 http://static.aijiacms.com/，注意以 / 结尾，建议设置为域名根目录且不能包含file/upload');?></td>
</tr>
<tr> 
...
<tr>
<td class="tl">信任域名</td>
<td><input name="setting[safe_domain]" type="text" value="<?php echo $safe_domain;?>" size="60"/><?php tips('不填写则默认为当前域名<br/>多个域名请用|分开 例如aijiacms.com|aijiacms.cn');?></td>
</tr>
<tr>
...
<td><input name="config[cookie_domain]" type="text" value="<?php echo $cookie_domain;?>" size="20"/><?php tips('例如要保证顶级域名aijiacms.com所有二级域名均可正常登录注销，则填写.aijiacms.com(注意顶级域名前加.)');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">中文字体</td>
<td><input name="setting[water_font]" type="text" value="<?php echo $water_font;?>" size="30"> <?php if($water_font && !is_file(AJ_ROOT."/file/font/".$water_font)){ ?><span class="f_red">字体不存在,请上传字体到./file/font/目录</span><?php } ?></td>
</tr>
<tr>
<td class="tl">文字大小</td>
...
<input type="radio" name="setting[mail_type]" value="sc"  <?php if($mail_type=="sc"){ ?>checked <?php } ?> onclick="Dh('dsmtp');Ds('demail');Dd('l_n').checked=true;" id="mailtype_sc"/> <label for="mailtype_sc">通过 <a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://sendcloud.sohu.com/" target="_blank" class="t">SendCloud</a> 发送<?php tips('SendCloud邮件发送可以保证更高的送达率，详情可以进入官方网站了解<br/>邮箱帐号请填写申请到的API_USER，邮箱密码请填写申请到的API_KEY');?></label>
</td>
</tr>
<tr>
...
<tr> 
<td class="tl">会员发布房源发送邮件</td>
<td>
<input type="radio" name="setting[mail_fabu]" value="1"  <?php if($mail_fabu) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[mail_fabu]" value="0"  <?php if(!$mail_fabu) echo 'checked';?>/> 关闭
</td>
</tr>
...
<td>
<?php
$NAME = array('普通', '新房预约', '二手房预约', '租房预约', '信使');
...
<td class="tl">短信接口</td>
<td>
<input type="radio" name="setting[sms_type]" value="0"  <?php if($sms_type==0){ ?>checked <?php } ?> onclick="Dh('alisms');"/> 吉信通&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[sms_type]" value="1"  <?php if($sms_type==1){ ?>checked <?php } ?> onclick="Dh('alisms');"/> 短信宝&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[sms_type]" value="2"  <?php if($sms_type==2){ ?>checked <?php } ?> onclick="Ds('alisms');"/> 阿里云短信&nbsp;&nbsp;&nbsp;&nbsp;

</tr>
<tr>
<td class="tl">短信接口帐号</td>
<td><input name="setting[sms_uid]" type="text" value="<?php echo $sms_uid;?>" size="30"/><a href="http://www.winic.org/" target="_blank" class="t">[申请帐号]</a></td> 
</tr>
<tr>
...
<tr>
<td class="tl">验证码位数</td>
<td><input name="setting[sms_code_number]" type="text" value="<?php echo $sms_code_number;?>" size="10"/> <?php tips('短信验证码位数，一般为6位');?></td> 
</tr>
</tr>
<tr >
<td class="tl">短信长度</td>
...
<tbody id="alisms" style="display:<?php if($AJ['sms_type']!=2) echo 'none';?>">


<!--此处仅增加短信通知模板，其它的按需新增-->

<tr>
<td class="tl">通用-短信模板ID</td>
<td><input name="setting[sms_code]" type="text" value="<?php echo $sms_code;?>" size="30"/> <?php tips('需要填写已经申请通过的模板，变量名为code');?></td> 
</tr>
<tr>
<td class="tl">用户登录-短信模板ID</td>
<td><input name="setting[sms_login]" type="text" value="<?php echo $sms_login;?>" size="30"/> <?php tips('需要填写已经申请通过的模板，变量名为code');?></td> 
</tr>
<tr>
<td class="tl">用户注册-短信模板ID</td>
<td><input name="setting[sms_user_reg]" type="text" value="<?php echo $sms_user_reg;?>" size="30"/> <?php tips('需要填写已经申请通过的模板，变量名为code');?></td> 
</tr>
<!--
<tr>
<td class="tl">密码找回-短信模板ID</td>
<td><input name="setting[sms_user_forget_pwd]" type="text" value="<?php echo $sms_user_forget_pwd;?>" size="30"/> <?php tips('需要填写已经申请通过的模板，变量名为code');?></td> 
</tr>
<tr>
<td class="tl">手机号码绑定-短信模板ID</td>
<td><input name="setting[sms_user_mobile_binding]" type="text" value="<?php echo $sms_user_mobile_binding;?>" size="30"/> <?php tips('需要填写已经申请通过的模板，变量名为code');?></td> 
</tr>-->
</tbody>
<tr>
...
<td class="tl">百度推送</td>
<td>
<input type="radio" name="setting[baidu_tui]" value="1"  <?php if($baidu_tui){ ?>checked <?php } ?> onclick="Ds('dbaidu_tui');"/> 开启&nbsp;&nbsp;
<input type="radio" name="setting[baidu_tui]" value="0"  <?php if(!$baidu_tui){ ?>checked <?php } ?> onclick="Dh('dbaidu_tui');"/> 关闭&nbsp;&nbsp;&nbsp;&nbsp;

</td>
</tr>

<tbody id="dbaidu_tui" style="display:<?php if(!$baidu_tui) echo 'none';?>">

<tr>
<td class="tl">百度site</td>
...
<tr>
<td class="tl">百度token</td>
<td><input name="setting[baidu_token]" type="text" id="baidu_token" size="30" value="<?php echo $baidu_token;?>" onfocus="if(this.value.indexOf('**')!=-1)this.value='';"/></td>
</tr>
...
<div class="tt">条件筛选</div>
 <li class="l1">操作提示：必须为数字，不能带中文，多个数据间用<span class="red">小写</span>的逗号隔开，如：1,2,3,4,5,6</li><br>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">楼盘价格</td>
<td><input type="text" name="setting[houseprice]" value="<?php echo $houseprice;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">二手房价格</td>
<td><input type="text" name="setting[saleprice]" value="<?php echo $saleprice;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">二手房建面</td>
<td><input type="text" name="setting[salearea]" value="<?php echo $salearea;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">租房价格</td>
<td><input type="text" name="setting[rentprice]" value="<?php echo $rentprice;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">租房建面</td>
<td><input type="text" name="setting[rentarea]" value="<?php echo $rentarea;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">求购建面</td>
<td><input type="text" name="setting[buyarea]" value="<?php echo $buyarea;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">房源楼层</td>
<td><input type="text" name="setting[floor]" value="<?php echo $floor;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">房源房龄</td>
<td><input type="text" name="setting[houseyear]" value="<?php echo $houseyear;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">商铺出租</td>
<td><input type="text" name="setting[spczprice]" value="<?php echo $spczprice;?>" size="60"/></td>
</tr>
<tr>
<td class="tl">商铺出售</td>
<td><input type="text" name="setting[spcsprice]" value="<?php echo $spcsprice;?>" size="60"/></td>
</tr>
</table>
</div>
<div id="Tabs10" style="display:none">
<table cellpadding="2" cellspacing="1" class="tb">


<tr>
<td class="tl">预约刷新间隔时间</td>
<td><input type="text" name="setting[appTime]" value="<?php echo $appTime;?>" size="5"/>&nbsp;&nbsp;&nbsp;&nbsp;每隔多少分钟为一个预约刷新段(分钟/单位)</td>
</tr>

<tr>
<td class="tl">预约方案执行天数</td>
<td><input type="text" name="setting[appNum]" value="<?php echo $appNum;?>" size="5"/>&nbsp;&nbsp;&nbsp;&nbsp;可以提前预约多少天</td>
</tr>

<tr>
<td class="tl">刷新一条信息一次扣除</td>
<td><input type="text" size="5" name="setting[yycredit_refresh]" value="<?php echo $yycredit_refresh;?>"/>&nbsp;&nbsp;&nbsp;&nbsp;预约刷新扣除积分</td>
</tr>
<tr>
<td class="tl">预约刷新权限分配</td>
<td><?php echo group_checkbox('setting[yuyue_group][]', $yuyue_group);?>&nbsp;&nbsp;&nbsp;&nbsp;选择可以使用此功能的会员</td>
</tr>
<tr>
<td class="tl">时间段预约刷新总次数</td>
<td><input type="text" name="setting[appCountNum]" value="<?php echo $appCountNum;?>" size="5"/>&nbsp;&nbsp;&nbsp;&nbsp;每个时间段最多可以预约刷新多少个房源</td>
</tr>
</table>
</div>

<div id="Tabs11" style="display:none">
<table cellpadding="2" cellspacing="1" class="tb">

<tbody id="wx">
<tr>
<td class="tl">微信AppID小程序ID</td>
<td><input name="setting[AppID]" type="text" value="<?php echo $AppID;?>" size="30"/></td> 
</tr>
<tr>
<td class="tl">微信AppSecret小程序密钥</td>
<td><input name="setting[AppSecret]" type="text" id="AppSecret" size="60" value="<?php echo $AppSecret;?>" onfocus="if(this.value.indexOf('**')!=-1)this.value='';"/></td>
</tr>

</tbody>
<tbody id="dy" >
<tr>
<td class="tl">头条AppID小程序ID</td>
<td><input name="setting[ToutiaoAppID]" type="text" value="<?php echo $ToutiaoAppID;?>" size="30"/></td> 
</tr>
<tr>
<td class="tl">头条AppSecret小程序密钥</td>
<td><input name="setting[ToutiaoAppSecret]" type="text" id="ToutiaoAppSecret" size="60" value="<?php echo $ToutiaoAppSecret;?>" onfocus="if(this.value.indexOf('**')!=-1)this.value='';"/></td>
</tr>
</tbody>
<tbody id="bd" >
<tr>
<td class="tl">百度AppID小程序ID</td>
<td><input name="setting[BaiduAppID]" type="text" value="<?php echo $BaiduAppID;?>" size="30"/></td> 
</tr>
<tr>
<td class="tl">百度AppSecret小程序密钥</td>
<td><input name="setting[BaiduAppSecret]" type="text" id="BaiduAppSecret" size="60" value="<?php echo $BaiduAppSecret;?>" onfocus="if(this.value.indexOf('**')!=-1)this.value='';"/></td>
</tr>
