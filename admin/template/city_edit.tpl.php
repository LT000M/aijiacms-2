...
<td><input name="post[domain]" type="text" size="40" value="<?php echo $domain;?>"/><?php tips('例如http://xian.aijiacms.com/,以 / 结尾<br/>同时在服务器端绑定此域名至网站根目录，如果不绑定请勿填写');?></td>
</tr>
<tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 地图坐标设置</td>
<td><input name="post[map_mid]" type="text" id="map_mid" value="<?php echo $map_mid;?>" size="41">&nbsp;&nbsp;<a href="http://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank" >拾取地图坐标</a></td>
</tr>
</table>
