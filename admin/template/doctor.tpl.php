...
<td class="dm"><?php echo AJ_IP;?></td>
<td class="dr">
查看<a href="<?php echo AJ_PATH;?>api/redirect.php?url=https://www.baidu.com/s?wd=ip" target="_blank" class="t">真实IP</a>，如果IP错误可能会影响注册和发布信息<br/>
所属地区为<?php echo ip2area(AJ_IP);?>，如果所在地错误，请及时<a href="<?php echo AJ_PATH;?>api/redirect.php?url=http://www.cz88.net/" target="_blank" class="t">更新IP数据库</a>
</td>
</tr>
