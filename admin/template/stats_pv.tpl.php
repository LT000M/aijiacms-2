...
<tr>
<th width="150"><a href="javascript:;" onclick="Dq('order','<?php echo $order == 2 ? 1 : 2;?>');">时间 <img src="<?php echo AJ_STATIC;?>file/image/ico-<?php echo $order == 2 ? 'asc' : ($order == 1 ? 'dsc' : 'ord');?>.png" width="11" height="11"/></a></th>
<th>网址</th>
...
<td data-hide-1200="1" title="<?php echo $v['refer'];?>"><input type="text" size="40" value="<?php echo $v['refer'];?>"/> <a href="<?php echo $v['refer'] ? AJ_PATH.'api/redirect.php?url='.urlencode($v['refer']) : '###';?>"<?php echo $v['refer'] ? ' target="_blank"' : '';?>><img src="admin/image/link.png" width="16" height="16" title="点击打开网址" alt="" align="absmiddle"/></a></td>
<td><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=uv&ip=<?php echo $v['ip'];?>', '<?php echo $v['ip'];?> - UV记录');"><?php echo $v['ip'];?></a></td>
<td data-hide-1200="1" title="<?php echo $v['area'];?>"><input type="text" size="15" value="<?php echo $v['area'];?>"/></td>
<td><a href="javascript:_user('<?php echo $v['username'];?>');"><?php echo $v['username'];?></a></td>
<td><a href="javascript:_user('<?php echo $v['homepage'];?>');"><?php echo $v['homepage'];?></a></td>
<td><a href="javascript:;" onclick="Dq('pc','<?php echo $v['pc'];?>');"> <?php echo $v['pc']==1 ? '电脑' : $v['pc'];?></a></td>
...
<div class="btns">
<input type="button" value="记录清理" class="btn-r" onclick="if(confirm('为了系统安全，系统仅删除30天之前的记录')){Go('?file=<?php echo $file;?>&action=clear_pv');}"/>&nbsp;
</div>
