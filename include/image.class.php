...
class image {
	...
	function __construct($g_img) {
        ...
        $this->pos = $AJ['water_pos'] ? $AJ['water_pos'] : 0;
		$this->w_img = AJ_ROOT.'/file/image/'.($AJ['water_mark'] ? $AJ['water_mark'] : 'watermark.png');
		$this->transition = $AJ['water_transition'] ? $AJ['water_transition'] : 65;
		$this->jpeg_quality = $AJ['water_jpeg_quality'] ? $AJ['water_jpeg_quality'] : 80;
		$this->text = $AJ['water_text'] ? $AJ['water_text'] : 'www.aijiacms.com';
		$this->text_size = $AJ['water_fontsize'] ? $AJ['water_fontsize'] : 20;
		$this->text_font = AJ_ROOT.'/file/font/'.($AJ['water_font'] ? $AJ['water_font'] : 'simhei.ttf');
		$this->text_color = $AJ['water_fontcolor'] ? $AJ['water_fontcolor'] : '#000000';
		$this->water_margin = $AJ['water_margin'] ? $AJ['water_margin'] : 10;
	}
